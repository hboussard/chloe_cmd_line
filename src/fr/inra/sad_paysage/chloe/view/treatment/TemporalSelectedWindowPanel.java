...
public class TemporalSelectedWindowPanel extends TreatmentPanel {
	
	private static final long serialVersionUID = 1L;
	
	public TemporalSelectedWindowPanel(Wizard wizard) {
		super(wizard);
	}
	
	@Override
	public String toString(){
		return "temporal selected";
	}

	@Override
	protected void locateComponents() {
		title.setText("Temporal Selected Window Analysis");
	...
	public void run() {
		/*
		getController().runTemporalSelectedWindow(inputMatrix, 
				(String) cbType.getSelectedItem(), (WindowShapeType) cbShape.getSelectedItem(), friction, frictionMatrix, 
				windowSize, pixels, metrics, taOutputFolder.getText(), 
