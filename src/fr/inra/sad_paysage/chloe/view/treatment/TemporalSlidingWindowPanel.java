...
public class TemporalSlidingWindowPanel extends TreatmentPanel {
	
	private static final long serialVersionUID = 1L;

	public TemporalSlidingWindowPanel(Wizard wizard) {
		super(wizard);
	}
	
	@Override
	public String toString(){
		return "temporal sliding";
	}
	
	@Override
	protected void locateComponents() {
		title.setText("Temporal Sliding Window");
	...
	public void run() {
		/*
		getController().runTemporalSlidingWindow(inputMatrix, (String) cbType.getSelectedItem(), 
				(WindowShapeType) cbShape.getSelectedItem(), friction, frictionMatrix,
				windowSize, (Integer) spDelta.getValue(), cbInterpolate.isSelected(), metrics, taOutputFolder.getText(), 
